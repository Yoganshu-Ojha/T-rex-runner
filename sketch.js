...
function setup(){
  ...
  trex = createSprite(50,167,20,50);
 ...
 // trex.addImage(trex_collide);
  ...
  ing = createSprite(300,197,600,10);
  ing.visible=false;
...
function clouds () {
if(frameCount%120==0) {
  cloud = createSprite(750,50,20,30);
  cloud.addImage(cloud_image);
  cloud.scale=0.5
  cloud.velocityX=-2;
  rand=Math.round(random(10,80))
  cloud.y=rand
...
if(frameCount%180==0) {
  ...
  obstacle1=createSprite(650,175,20,60);
